...
def my_receive_callback(data, stream_area):
    ...
    if (response == (CMD_GET_DISTANCESENSORS | RESP_BIT)):
        ...
        # --------------------------------------------------------------------------
        combined5_int = int.from_bytes(new_byte_array[8:10], byteorder='big')  # 'big' for big-endian, 'little' for little-endian
        SetDistanceButtonBGColor(distance5_Front, combined5_int)
        
        # --------------------------------------------------------------------------
        combined6_int = int.from_bytes(new_byte_array[10:12], byteorder='big')  # 'big' for big-endian, 'little' for little-endian
        SetDistanceButtonBGColor(distance6_Front, combined6_int)

        # --------------------------------------------------------------------------
        combined7_int = int.from_bytes(new_byte_array[12:14], byteorder='big')  # 'big' for big-endian, 'little' for little-endian
        SetDistanceButtonBGColor(distance7_Front, combined7_int)

        # --------------------------------------------------------------------------
        combined8_int = int.from_bytes(new_byte_array[14:16], byteorder='big')  # 'big' for big-endian, 'little' for little-endian
...
def show_gui(mod_manager):
    ...
    distance5_Front = tk.Button(frame, 
                              height= 1, 
                              width=10, 
                              text="inf")
    ...
    distance6_Front = tk.Button(frame, 
                              height= 1, 
                              width=10, 
                              text="inf")
    ...
    distance7_Front = tk.Button(frame, 
                              height= 1, 
                              width=10, 
                              text="inf")
    ...
    distance8_Front = tk.Button(frame, 
                              height= 1, 
                              width=10, 
                              text="inf")
